		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Entregas",
									"targetURL": "#arledesmafiorimmpaniolesentregas-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"arledesmafiorimmpaniolesentregas-display": {
								"semanticObject": "arledesmafiorimmpaniolesentregas",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=ar.ledesma.fiori.mm.panioles.entregas",
									"url": sap.ui.require.toUrl("ar/ledesma/fiori/mm/panioles/entregas")
								}
							}
						}
					}
